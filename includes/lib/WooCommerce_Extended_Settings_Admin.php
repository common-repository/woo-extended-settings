 ...
 * Admin API class.
 */
class WooCommerce_Extended_Settings_Admin
{
    ...
    public function display_field($data = array(), $post = null, $echo = true)
    {
        ...
        switch ($field['type']) {
            ...
            case 'image':
                ...
                $html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __('Upload an image', 'woocommerce-extended-settings') . '" data-uploader_button_text="' . __('Use image', 'woocommerce-extended-settings') . '" class="image_upload_button button" value="' . __('Upload new image', 'woocommerce-extended-settings') . '" />' . "\n";
                $html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __('Remove image', 'woocommerce-extended-settings') . '" />' . "\n";
        ...
        switch ($field['type']) {
            ...
            case 'info_box':
                $html .= '<strong style="font-size:15px;">' . $field['description'] . '</strong>';
                break;
